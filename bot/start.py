...
async def _settings(event):
        ...
        [Button.inline('🖤 VBR ❤', 'vbrcrf_settings')],
...
async def _change_metadata(event):
        ...
        if link=="invalid":
            ...
            if new_event and new_event not in ["cancelled", "stopped"]:
                ...
                return
        metadata_event = await ask_text_event(chat_id, user_id, event, 120, "❤ Metadata Change 🖤", message_hint="**Send Message Like This:**\ntitle-title-title-title\n\n❤ **1st 'title'** will change Movie Name.\n🖤 **2nd 'title'** will change Title of all Video Streams.\n❤ **3rd 'title'** will change Title of all Audio Streams.\n🖤 **4th 'title'** will change Title of all Subtitiles Streams.\n\n**Note:** You have to send/use all title in your message.\n\n**Example Message :**\n`Movie Name-Video Title-Audio Title-Subtitle Title`")
